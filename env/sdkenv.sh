...
ANDROID_CLANG_VERSION=${ANDROID_CLANG_VERSION:-r353983c1}
ANDROID_NDK_ROOT=${ANDROID_NDK_ROOT:-$ANDROID_ROOT/android-ndk-$ANDROID_NDK_VERSION-clang-$ANDROID_CLANG_VERSION}
